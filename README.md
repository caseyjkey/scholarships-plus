...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create scholarships-plus-9c68
  fly apps create scholarships-plus-9c68-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app scholarships-plus-9c68
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app scholarships-plus-9c68-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'scholarships-plus-9c68-staging' does not match app name in config file 'scholarships-plus-9c68'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name scholarships-plus-9c68-db
  fly postgres attach --app scholarships-plus-9c68 scholarships-plus-9c68-db

  fly postgres create --name scholarships-plus-9c68-staging-db
  fly postgres attach --app scholarships-plus-9c68-staging scholarships-plus-9c68-staging-db
  ```
